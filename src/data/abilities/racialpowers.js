const racialPowersAndFeats = {
  ...
  "Dwarf": {
    "That's Your Best Shot?" : { 
      "Base": "Once per battle as a free action after you have been hit by an enemy attack, you can heal using a recovery. If the escalation die is less than 2, you only get half the usual healing from the recovery. Unlike other recoveries that might allow you to take an average result, you have to roll this one! \n\nNote that you can't use this ability if the attack drops you to 0 hp or below. You've got to be on your feet to sneer at their attack and recover.",
      "Champion": "If the escalation die is 2+ when you use that's your best shot, the recovery is free."
    },
  },
  "Gnome": {
    "Small" : { 
      "Base": "Gnomes have a +2 AC bonus against opportunity attacks.",
    },
    "Confounding" : { 
      "Base": "Once per battle, when you roll a natural 16+ with an attack, you can also daze the target until the end of your next turn.",
      "Champion": "Instead of being dazed, the target of your confounding ability is weakened until the end of your next turn."
    },
    "Minor Illusions" : { 
      "Base": "As a standard action, at-will, you can create a strong smell or a sound nearby. Nearby creatures that fail a normal save notice the smell or sound. Creatures that make the save may notice it but recognize it as not exactly real.",
    },
  },
  "Half-elf": {
    "Surprising" : { 
      "Base": "Once per battle, subtract one from the natural result of one of your own d20 rolls.",
  ...
  "Halfling": {
    "Small" : { 
      "Base": "Halflings have a +2 AC bonus against opportunity attacks.",
    },
    "Evasive" : { 
      "Base": "Once per battle, force an enemy that hits you with an attack to reroll the attack with a -2 penalty.",
      "Champion": "The enemy's reroll takes a -5 penalty instead."
    },
  },
  "Half-orc": {
    "Lethal" : { 
      "Base": "Once per battle, reroll a melee attack and use the roll you prefer as the result.",
      "Champion": "If the lethal attack reroll is a natural 16+, you can use lethal again later this battle."
    },
  },
  "High Elf": {
    "Highblood Teleport" : { 
      "Base": "Once per battle as a move action, place yourself in a nearby location you can see.",
  ...
  "Human": {
    "Bonus Feat" : { 
      "Base": "At 1st level, human PCs start with two feats instead of one.",
    },
    "Quick to Fight" : { 
      "Base": "At the start of each battle, roll initiative twice and choose the result you want.",
